...
<aside class="sidebar" data-sidebar :class="{ 'is-collapsed': !expanded, 'is-mobile-open': mobileOpen }">
  <div class="sidebar-panel glass">
    ...
    <nav class="nav" aria-label="Main navigation">
      <button type="button" class="nav-link" :class="page === 'overview' ? 'is-active' : ''"
        @click="go('overview'); mobileOpen = false">
      ...
      <button type="button" class="nav-link" :class="page === 'languages' ? 'is-active' : ''"
        @click="go('languages'); mobileOpen = false">
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
          stroke-linejoin="round" aria-hidden="true">
      ...
      <button type="button" class="nav-link" :class="page === 'locked' ? 'is-active' : ''"
        @click="go('locked'); mobileOpen = false">
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
          stroke-linejoin="round" aria-hidden="true">
      ...
      <button type="button" class="nav-link" :class="page === 'history' ? 'is-active' : ''"
        @click="go('history'); mobileOpen = false">
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
          stroke-linejoin="round" aria-hidden="true">
      ...
      <button type="button" class="nav-link" :class="page === 'unused' ? 'is-active' : ''"
        @click="go('unused'); mobileOpen = false">
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
          stroke-linejoin="round" aria-hidden="true">
          <path
      ...
      <button type="button" class="nav-link" :class="page === 'backups' ? 'is-active' : ''"
        @click="go('backups'); mobileOpen = false">
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
          stroke-linejoin="round" aria-hidden="true">
      ...
      <button type="button" class="nav-link" :class="page === 'settings' ? 'is-active' : ''"
        @click="go('settings'); mobileOpen = false">
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
          stroke-linejoin="round" aria-hidden="true">
          <path
  ...
  <div class="support-card glass">
    ...
    <a class="support-link support-link--coffee" href="https://github.com/sponsors/Youssef-Mekkkawy" target="_blank"
      rel="noreferrer">
      <span aria-hidden="true">☕</span>
      <span x-show="expanded">Buy me a coffee</span>
    </a>
    <a class="support-link support-link--github" href="https://github.com/Youssef-Mekkkawy/laravel-ai-translator"
