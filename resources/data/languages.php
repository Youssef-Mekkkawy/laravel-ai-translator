...
/**
 * Full ISO 639-1 language list used by the "Add language" picker
 * (and available for reuse anywhere else the package needs a
 * canonical list of language codes/names — e.g. backend validation).
 *
 * Each entry: code (ISO 639-1), name (English), native (native name).
 */
